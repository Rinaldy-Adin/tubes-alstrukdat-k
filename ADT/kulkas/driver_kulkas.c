...
// gcc driver_kulkas.c kulkas.c ../matrix/matrix.c ../strlib/strlib.c ../makanan/makanan.c ../liststatik/listStatik.c ../waktu/waktu.c ../charmachine/charmachine.c ../wordmachine/wordmachine.c ../tree/tree.c ../prioqueue/prioqueue.c -o driver_kulkas 
// ./driver_kulkas
...
int main() {
    ...
    printf("Penjelasan makanan (hanya berlaku driver ini saja sebagai contoh): \n" 
