...
typedef Makanan ElTypeStat;  /* type elemen List */
typedef int IdxType;
typedef struct {
   ElTypeStat contents[CAPACITYSTAT]; /* memori tempat penyimpan elemen (container) */
...
/* ********** SORTING ********** */
void sortListStat(ListMakanan *l, boolean asc);
/* I.S. l boleh kosong */
