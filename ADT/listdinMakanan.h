...
#ifndef ListDinMakanan_H
#define ListDinMakanan_H
...
/* Jika l adalah : ListDinMakanan, cara deklarasi dan akses: */
/* Deklarasi : l : ListDinMakanan */
/* Maka cara akses:
...
ListDinMakanan plusMinusList(ListDinMakanan l1, ListDinMakanan l2, boolean plus);
...
boolean isListEqualDin(ListDinMakanan l1, ListDinMakanan l2);
/* Mengirimkan true jika l1 sama dengan l2 yaitu jika nEff l1 = l2 dan semua elemennya sama */

/* ********** SEARCHING ********** */
/* ***  Perhatian : list boleh kosong!! *** */
IdxType indexOfDin(ListDinMakanan l, Word searchId);
...
// ElType sumList(ListDinMakanan l);
// /* Menghasilkan hasil penjumlahan semua elemen l */
// /* Jika l kosong menghasilkan 0 */
// int countVal(ListDinMakanan l, ElType val);
